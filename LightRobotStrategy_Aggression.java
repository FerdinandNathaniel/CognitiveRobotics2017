...
public class LightRobotStrategy_Aggression implements Strategy {
	/*****LIGHTROBOTSTRATEGY*****
	...
	public LightRobotStrategy_Aggression (Robot robot) {
		this.robot = robot;
	}

	@Override
	public void startStrategy(Robot robot) {
		System.out.println("Starting LightRobotStrategy - Aggression");
	}
